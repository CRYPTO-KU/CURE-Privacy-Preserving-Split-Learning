#!/bin/bash
# Run MNIST FC benchmarks for prior work comparison
# Cores: 24 (Glyph), 30 (Nandakumar et al.)
...
echo "=========================================="
echo "MNIST FC Benchmark - Prior Work Comparison"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "MNIST FC benchmarks completed!"
echo "=========================================="
echo "Output files:"
