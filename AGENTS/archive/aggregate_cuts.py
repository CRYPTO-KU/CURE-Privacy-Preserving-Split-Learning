...
def main():
    ...
    ap.add_argument("--root", default="AGENTS/results/bench0718_raw", help="Root directory containing microbenchmark CSVs")
    ap.add_argument("--out", default="AGENTS/results/cut_aggregates.csv")
    args = ap.parse_args()
